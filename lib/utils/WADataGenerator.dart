...
List<JNSCutiModel> jnsCutiList() {
  List<JNSCutiModel> list = [];
  list.add(JNSCutiModel(name: 'Tahunan'));
  list.add(JNSCutiModel(name: 'Sakit'));
  list.add(JNSCutiModel(name: 'Istimewa'));
  list.add(JNSCutiModel(name: 'Ibadah Keagamaan'));
  list.add(JNSCutiModel(name: 'Karena Alasan Penting'));
  list.add(JNSCutiModel(name: 'Di luar tanggungan negara'));
  list.add(JNSCutiModel(name: 'Tahunan ke luar negeri'));
  list.add(JNSCutiModel(name: 'Keterangan lainnya'));
  return list;
}
